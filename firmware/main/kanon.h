...
/* Hard rule: hourly aggregates with fewer than this many distinct events
 * must not be published at hourly resolution; collapse them into the
 * daily aggregate instead (k-anonymity threshold). */
